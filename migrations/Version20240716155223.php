 ...
 */
final class Version20240716155223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD is_url TINYINT(1) NOT NULL');
        ...
        $this->addSql('ALTER TABLE
          user
        ADD
          CONSTRAINT FK_8D93D649292E8AE2 FOREIGN KEY (profile_picture_id) REFERENCES image (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image DROP is_url');
